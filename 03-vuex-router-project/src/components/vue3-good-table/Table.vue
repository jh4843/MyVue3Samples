...
export default {
  ...
  computed: {
    ...
    processedRows() {
      ...
      if (this.searchTrigger === "enter") {
        this.setFilterRows(computedRows);
  ...
  methods: {
    ...
    searchTableOnEnter(searchTerm) {

      if (this.searchTrigger === "enter") {
        this.globalSearchTerm = searchTerm;

        console.log(this.searchTerm + ' , ' + this.globalSearchTerm);
